#!/bin/bash
# ============================================================================
# 上传 CamSFT-8B checkpoint 到 HuggingFace Hub
# ============================================================================
# 用法:
#   bash upload_camsft_8b_to_hf.sh
#
# 前置条件:
...
# ================================
HF_TOKEN="***REMOVED***"
CKPT_DIR="/group/40009/dazhaodu/ms-swift/output/camera_sft_qwen3vl_8b/v0-20260708-112218/checkpoint-1326"
