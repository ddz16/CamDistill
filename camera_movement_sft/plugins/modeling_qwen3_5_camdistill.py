...
def _inject_camera_into_video_embeds(
    ...
    for t, h, w in video_grid_thw.tolist():
        ...
        for frame_idx in range(t):
            results.append(camera_embeds[cam_offset:cam_offset + 1])
            results.append(video_embeds[vis_offset:vis_offset + patches_per_frame])
...
def _expand_video_placeholders(
    ...
    for b in range(B):
        ...
        for i in range(seq_len):
            ...
            if new_attn is not None:
                new_attn[b, dst] = attention_mask[b, i]
            dst += 1

    return new_input_ids, new_mm_type, new_attn
...
class Qwen3_5Model(Qwen3_5PreTrainedModel):
    ...
    def get_vision_position_ids(
        ...
        If include_camera_token=True, prepends one camera token position per frame at the center.
        """
        ...
        if include_camera_token:
            ...
            for t_idx in range(llm_grid_t):
                ...
                cam_pos = torch.tensor([[cam_temporal], [cam_center_h], [cam_center_w]],
            ...
            for modality_type, start_idx, end_idx in input_type_group:
                ...
                # image == 1, video == 2
                    ...
                    vision_position_ids = self.get_vision_position_ids(
                        ...
                        device=input_ids.device, include_camera_token=_include_cam
                    )
