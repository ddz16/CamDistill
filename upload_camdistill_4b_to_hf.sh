#!/bin/bash
# ============================================================================
# 上传 CamDistill-4B checkpoint 到 HuggingFace Hub
# ============================================================================
# 用法:
#   bash upload_camdistill_4b_to_hf.sh
#
# 前置条件:
...
# ================================
HF_TOKEN="***REMOVED***"
CKPT_DIR="/group/40009/dazhaodu/ms-swift/output/camera_sft_qwen3vl_4b_camdistill/v39-20260712-014018/checkpoint-1326"

# 目标仓库名（<username>/<repo_name>）
# 如果你想上传到个人账户，用户名可留空，脚本会通过 whoami 自动读取
HF_USERNAME=""          # 留空则自动检测；也可写死，如 "yourname"
REPO_NAME="CamDistill-4B"
