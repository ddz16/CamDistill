#!/bin/bash
# ============================================================================
# 上传 CamSFT-4B checkpoint 到 HuggingFace Hub
# ============================================================================
# 用法:
#   bash upload_camsft_4b_to_hf.sh
#
# 前置条件:
...
# ================================
HF_TOKEN="***REMOVED***"
CKPT_DIR="/group/40009/dazhaodu/ms-swift/output/camera_sft_qwen3vl_4b/v7-20260707-101801/checkpoint-1326"
